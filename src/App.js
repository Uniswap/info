    ...
    if (this.state.overviewPage)
      return (
        <ApolloProvider client={client}>
          <Wrapper>
            <OverviewPageHeader px={24} py={3} bg={['mineshaft', 'transparent']} color={['white', 'black']}>
              <OverviewTitle />
              <Flex>
                <Button
                  fontSize={15}
            ...
            <Overview mx="auto">
              <Panel rounded bg="white" alignItems="center" area="totals">
                ...
                <Box p={24}>
                  ...
                  <Divider />
                  <Flex justifyContent="center" p={24} mb={-24}>
                    <Button
                      fontSize={16}
                      lineHeight={1.4}
                      fontWeight={400}
        ...
        <Wrapper>
          ...
          <Dashboard mx="auto" px={[0, 3]}>
            ...
            <Panel rounded bg="white" area="exchange">
              ...
              <Divider />
              <Flex alignItems="end" justifyContent="center" p={24} mb={-24}>
                <Button
                  fontSize={16}
                  lineHeight={1.4}
                  fontWeight={400}
