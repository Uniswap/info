...
import { ButtonPrimary, ButtonLight, ButtonError, ButtonConfirmed } from '../../components/ButtonStyled'
    ...
    return (
      <AutoColumn gap={'md'} style={{ marginTop: '20px' }}>
        <RowBetween align="flex-end">
          ...
          <RowFixed gap="4px">
            <TokenLogo address={currencyA} size={'24px'} />
        ...
        <RowBetween align="flex-end">
          ...
          <RowFixed gap="4px">
            <TokenLogo address={currencyB} size={'24px'} />
            <Text fontSize={24} fontWeight={500} style={{ marginLeft: '10px' }}>
              {currencyB?.symbol}
            </Text>
          </RowFixed>
                ...
                <LightCard>
                  <AutoColumn gap="10px">
                    <RowBetween>
                      ...
                      <RowFixed>
                        <TokenLogo address={currencyA} style={{ marginRight: '12px' }} />
                    ...
                    <RowBetween>
                      ...
                      <RowFixed>
                        <TokenLogo address={currencyB} style={{ marginRight: '12px' }} />
